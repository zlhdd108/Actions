...
[![Update Fancyss Rules](https://github.com/zlhdd108/Actions/actions/workflows/fancyss-rules-old.yml/badge.svg)](https://github.com/zlhdd108/Actions/actions/workflows/fancyss-rules-old.yml)   
...
- `sed -i 's/^\turl_main.*/\turl_main="https:\/\/cdn.jsdelivr.net\/gh\/zlhdd108\/Actions@master\/fancyss_rules"/g' /koolshare/scripts/ss_rule_update.sh`  （仅当更新规则时显示`"没有检测到在线版本，可能是访问github有问题"`时推荐，由于jsDelivr CDN存在最长24小时的缓存，规则更新会有延迟）
